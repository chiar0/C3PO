...
public class Darkboard extends AIPlayer {
	...
	private static Object getObject(String path) {
		InputStream is = (InputStream) agent.Darkboard.class.getResourceAsStream(path);
	...
	{
		Globals.PGNPath = Darkboard.class.getProtectionDomain().getCodeSource().getLocation().getPath().replace("Darkboard.jar", "resources/darkboard_data");
		...
		// Globals.whiteOpeningBook = (OpeningBook) getObject("darkboard_data/whiteopen.opn");
		Globals.whiteOpeningBook = null; // OpeningBook.load(new File(Globals.PGNPath + "/whiteopen.opn"));
		// System.out.println(Globals.whiteOpeningBook);

		// System.out.println("Loading Black Opening Book");
		// Globals.blackOpeningBook = (OpeningBook) getObject("darkboard_data/blackopen.opn");
		Globals.blackOpeningBook = null; // OpeningBook.load(new File(Globals.PGNPath + "/blackopen.opn"));
		// System.out.println(Globals.blackOpeningBook);

		// System.out.println("Loading Piece Density Statistics");
		// Globals.density = (PieceDensityInfo) getObject("darkboard_data/density.dns");
		Globals.density = PieceDensityInfo.load(new File(Globals.PGNPath+"/density.dns"));
		// System.out.println(Globals.density);

		// System.out.println("Loading Generic White Model");
		// Globals.whiteModel[0] = (PlayerModel) getObject("darkboard_data/genericwhitemodel.mdl");
		Globals.whiteModel[0] = PlayerModel.load(new File(Globals.PGNPath+"/genericwhitemodel.mdl"));
		// System.out.println(Globals.whiteModel[0]);

		// System.out.println("Loading Generic Black Model");
		// Globals.blackModel[0] = (PlayerModel) getObject("darkboard_data/genericblackmodel.mdl");
		Globals.blackModel[0] = PlayerModel.load(new File(Globals.PGNPath+"/genericblackmodel.mdl"));
		// System.out.println(Globals.blackModel[0]);

		// System.out.println("Loading Weak White Model");
		// Globals.whiteModel[1] = (PlayerModel) getObject("darkboard_data/weakwhitemodel.mdl");
		Globals.whiteModel[1] = PlayerModel.load(new File(Globals.PGNPath+"/weakwhitemodel.mdl"));
		// System.out.println(Globals.whiteModel[1]);

		// System.out.println("Loading Weak Black Model");
		// Globals.blackModel[1] = (PlayerModel) getObject("darkboard_data/weakblackmodel.mdl");
		Globals.blackModel[1] = PlayerModel.load(new File(Globals.PGNPath+"/weakblackmodel.mdl"));
		// System.out.println(Globals.blackModel[1]);

		// System.out.println("Loading Strong White Model");
		// Globals.whiteModel[2] = (PlayerModel) getObject("darkboard_data/strongwhitemodel.mdl");
		Globals.whiteModel[2] = PlayerModel.load(new File(Globals.PGNPath+"/strongwhitemodel.mdl"));
		// System.out.println(Globals.whiteModel[2]);

		// System.out.println("Loading Strong Black Model");
		// Globals.blackModel[2] = (PlayerModel) getObject("darkboard_data/strongblackmodel.mdl");
		Globals.blackModel[2] = PlayerModel.load(new File(Globals.PGNPath+"/strongblackmodel.mdl"));
		// System.out.println(Globals.blackModel[2]);
